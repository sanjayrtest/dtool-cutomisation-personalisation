...
import { TooltipBootstrap } from "../../../components/SideTab/Text/bootstrapTooltip";
...
const BuildText = ({
  ...
  const handleClick = (e) => {
    if (
      ...
      e.target.children[0]?.children[0]?.className?.baseVal ===
        "positionIcon" ||
      e.target.children[0]?.children[0]?.children[0]?.className?.baseVal ===
        "positionIcon"
    ) {
      return;
    } else {
    ...
    <div className={classes.TextPanel} onClick={() => layerCloseHandler()}>
      <Grid container spacing={3}>
        <Grid
          ...
          lg={12}
          xl={12}
          className={classes.scrollOverflow}
        >
          {mediaBreakXs && (
            <Typography
              variant="h3"
          ...
          <>
            <div>
              ...
              >
                ...
                <Box
                  className={classes.customDefault}
                  mr={1}
                  mb={1}
                  onClick={showPalatteHandler}
                >
                  <span
                  ...
                  <Box display="flex" flexWrap="wrap" mt={2}>
                    ...
                    >
                      <Button
                        ...
                        style={{
                          backgroundColor:
                            positionSelected === "left" ? "#fff8f0" : "white",
                          border:
                      ...
                      <Button
                        ...
                        style={{
                          backgroundColor:
                            positionSelected === "right" ? "#fff8f0" : "white",
                          border:
                      ...
                      <Button
                        ...
                        style={{
                          backgroundColor:
                            positionSelected === "top" ? "#fff8f0" : "white",
                          border:
